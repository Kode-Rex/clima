...
class TestWeatherTestingService:
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_nws_api_success(self, mock_weather_client, sample_location_search_response):
    ...
    async def test_nws_api_exception_handling(self, mock_weather_client):
        ...
        mock_weather_client.search_locations.side_effect = Exception("API Connection Error")
