...
class LocationService:
    ...
    async def get_location_weather(self, query: str, language: str = "en-us") -> dict:
        ...
        try:
            ...
            weather_result = await weather_service.get_current_weather(location_key, True)
    ...
    async def get_location_forecast(self, query: str, language: str = "en-us") -> dict:
        ...
        try:
            ...
            forecast_result = await forecast_service.get_5day_forecast(location_key, True)
    ...
    async def get_location_extended_forecast(self, query: str, days: int = 7, language: str = "en-us") -> dict:
        ...
        try:
            ...
            location_key = locations[0]["Key"]
            forecast_service = ForecastService(self.weather_client)
            forecast_result = await forecast_service.get_extended_forecast(location_key, days, True)
    ...
    async def get_location_hourly_forecast(self, query: str, hours: int = 168, language: str = "en-us") -> dict:
        ...
        try:
            ...
            location_key = locations[0]["Key"]
            forecast_service = ForecastService(self.weather_client)
            forecast_result = await forecast_service.get_hourly_forecast(location_key, hours, True)
