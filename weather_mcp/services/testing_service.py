    ...
    async def test_nws_api(self):
        ...
        try:
            ...
            if locations:
                ...
                extended_forecasts = await self.weather_client.get_7day_forecast(location_key)
                ...
                hourly_forecasts = await self.weather_client.get_hourly_forecast(location_key, hours=24)
                ...
                try:
                    grid_data = await self.weather_client.get_detailed_grid_data(location_key)
